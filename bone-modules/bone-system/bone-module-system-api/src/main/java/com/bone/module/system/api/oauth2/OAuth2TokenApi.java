...
@FeignClient(name = ApiConstants.NAME,contextId =ApiConstants.NAME+"OAuth2TokenApi") // TODO 芋艿：fallbackFactory =
...
public interface OAuth2TokenApi {
    ...
    @ApiImplicitParams({
        ...
        @ApiImplicitParam(name = "clientId", value = "客户端编号", required = true, dataTypeClass = String.class, example = "boneyuanma")
    })
