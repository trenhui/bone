...
import com.bone.base.tenant.core.util.TenantUtils;
...
import com.bone.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 bone.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
    ...
    private TenantDO validateUpdateTenant(Long id) {
        ...
        if (isSystemTenant(tenant)) {
            //todo throw exception(TENANT_CAN_NOT_UPDATE_SYSTEM);
        }
        return tenant;
    }
