package com.bone.module.system.service.auth;

import cn.hutool.core.util.ObjectUtil;
import com.bone.base.core.enums.CommonStatusEnum;
import com.bone.base.core.enums.UserTypeEnum;
import com.bone.base.core.util.monitor.TracerUtils;
import com.bone.base.core.util.servlet.ServletUtils;
import com.bone.base.core.util.validation.ValidationUtils;
import com.bone.module.system.api.logger.dto.LoginLogCreateReqDTO;
import com.bone.module.system.api.sms.SmsCodeApi;
import com.bone.module.system.api.social.dto.SocialUserBindReqDTO;
import com.bone.module.system.controller.admin.auth.vo.*;
import com.bone.module.system.convert.auth.AuthConvert;
...
import com.bone.module.system.enums.logger.LoginResultEnum;
import com.bone.module.system.enums.oauth2.OAuth2ClientConstants;
import com.bone.module.system.enums.sms.SmsSceneEnum;
import com.bone.module.system.service.logger.LoginLogService;
import com.bone.module.system.service.member.MemberService;
...
import static com.bone.base.core.util.servlet.ServletUtils.getClientIP;
...
public class AdminAuthServiceImpl implements AdminAuthService {
     ...
     * 验证码的开关，默认为 true
     */
    @Value("${bone.captcha.enable:true}")
    ...
    public AuthLoginRespVO socialLogin(AuthSocialLoginReqVO reqVO) {
        ...
        // 创建 Token 令牌，记录登录日志
        AuthLoginRespVO respVO= createTokenAfterLoginSuccess(user, LoginLogTypeEnum.LOGIN_SOCIAL);
        respVO.setLoginUserType(reqVO.getType());
        return respVO;
    }
    ...
    private AuthLoginRespVO createTokenAfterLoginSuccess(AdminUserDO user, LoginLogTypeEnum logType) {
        ...
        authLoginRespVO.setLoginUserType(getUserType().getValue());
        authLoginRespVO.setTenantId(user.getTenantId());
