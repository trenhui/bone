package com.bone.module.system.controller.admin.user.vo.user;
...
public class UserBaseVO {
    ...
    @ApiModelProperty(value = "用户账号", required = true, example = "bone")
    ...
    @ApiModelProperty(value = "用户邮箱", example = "bone@iocoder.cn")
