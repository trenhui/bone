package com.bone.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @ApiModelProperty(value = "Java 方法名", required = true, example = "com.bone.adminserver.UserController.save(...)")
