package com.bone.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.bone.base.core.enums.CommonStatusEnum;
import com.bone.base.core.exception.ServiceException;
import com.bone.base.core.pojo.PageResult;
import com.bone.base.core.util.collection.ArrayUtils;
import com.bone.base.core.util.collection.CollectionUtils;
import com.bone.base.test.core.ut.BaseDbUnitTest;
import com.bone.infra.api.file.FileApi;
...
import com.bone.module.system.controller.admin.user.vo.user.*;
import com.bone.module.system.dal.dataobject.dept.DeptDO;
import com.bone.module.system.dal.dataobject.dept.PostDO;
import com.bone.module.system.dal.dataobject.dept.UserPostDO;
...
import com.bone.module.system.dal.mysql.dept.UserPostMapper;
import com.bone.module.system.dal.mysql.user.AdminUserMapper;
import com.bone.module.system.enums.common.SexEnum;
...
import com.bone.module.system.service.tenant.TenantService;
...
import static com.bone.base.core.util.date.LocalDateTimeUtils.buildBetweenTime;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("boneyuanma");
        ...
        assertEquals("boneyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("boneyuanma"))).thenReturn("java");
