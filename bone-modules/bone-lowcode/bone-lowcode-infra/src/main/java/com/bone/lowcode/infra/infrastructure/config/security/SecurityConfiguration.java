package com.bone.lowcode.infra.infrastructure.config.security;
 ...
 */
@Configuration(proxyBeanMethods = false, value = "lowcodeInfraSecurityConfiguration")
public class SecurityConfiguration {

    @Value("${spring.boot.admin.context-path:''}")
    private String adminSeverContextPath;

    @Bean("lowcodeInfraAuthorizeRequestsCustomizer")
    public AuthorizeHttpRequestsCustomizer authorizeRequestsCustomizer() {
        return new AuthorizeHttpRequestsCustomizer() {
            ...
            public void customize(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry registry) {
                ...
                //registry.requestMatchers("/lowcode/infra/*/**").permitAll();

               // registry.requestMatchers("/*/infra/*/**").permitAll();
                registry.requestMatchers("/lowcode/infra/app/**").permitAll();
