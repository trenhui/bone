package com.bone.lowcode.studio.infrastructure.config.security;
...
/**
 * studio 模块的 Security 配置
 */
@Configuration(proxyBeanMethods = false, value = "studioSecurityConfiguration")
public class SecurityConfiguration {
    ...
    @Bean("studioAuthorizeRequestsCustomizer")
    public AuthorizeHttpRequestsCustomizer authorizeRequestsCustomizer() {
        return new AuthorizeHttpRequestsCustomizer() {
            ...
            public void customize(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry registry) {
                ...
                registry.requestMatchers("/studio/**").permitAll();
