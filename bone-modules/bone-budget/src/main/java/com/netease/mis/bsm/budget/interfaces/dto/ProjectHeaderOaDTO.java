...
*/
@Data
@Schema(description = "OA项目单头DTO")
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ProjectHeaderOaDTO extends TenantAbstractDTO<Long> {
         ...
         * 追加/新建业务币金额
         */
         @Schema(name = "追加/新建业务币金额")
        private BigDecimal addBizAmount;
        /**
         * 追加/新建本位币金额
         */
         @Schema(name = "追加/新建本位币金额")
         ...
         * 项目负责人（多个code，逗号隔开）
         */
         @Schema(name = "项目负责人（多个code，逗号隔开）")
        private String projectOwnersCode;
        /**
         * 项目成员（多个id，逗号隔开）
         */
         @Schema(name = "项目成员（多个id，逗号隔开）")
        private String projectEmployeeIds;
        /**
         * 项目成员（多个工号，逗号隔开）
         */
         @Schema(name = "项目成员（多个工号，逗号隔开）")
        private String projectEmployeesCode;
        /**
         * 同步状态，success：成功，error：失败
         */
         @Schema(name = "同步状态，success：成功，error：失败")
        private String syncStatus;
        /**
         * 接口同步消息，如果失败记录详细错误信息
         */
         @Schema(name = "接口同步消息，如果失败记录详细错误信息")
