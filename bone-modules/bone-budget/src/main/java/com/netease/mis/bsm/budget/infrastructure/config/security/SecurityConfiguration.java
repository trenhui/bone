package com.netease.mis.bsm.budget.infrastructure.config.security;
...
/**
 * budget 模块的 Security 配置
 */
@Configuration(proxyBeanMethods = false, value = "budgetSecurityConfiguration")
public class SecurityConfiguration {
    ...
    @Bean("budgetAuthorizeRequestsCustomizer")
    public AuthorizeHttpRequestsCustomizer authorizeRequestsCustomizer() {
        return new AuthorizeHttpRequestsCustomizer() {
            ...
            public void customize(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry registry) {
                ...
                registry.requestMatchers("/budget/**").permitAll();
