...
import com.bone.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import com.bone.infra.enums.codegen.CodegenColumnListConditionEnum;
import com.bone.infra.enums.codegen.CodegenTemplateTypeEnum;
...
public class CodegenBuilder {
    ...
    static {
        ...
        Arrays.stream(ReflectUtil.getFields(AbstractEntity.class)).forEach(field -> BASE_DO_FIELDS.add(field.getName()));
