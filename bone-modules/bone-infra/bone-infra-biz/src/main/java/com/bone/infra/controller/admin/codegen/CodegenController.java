package com.bone.infra.controller.admin.codegen;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.ZipUtil;
import com.bone.base.core.pojo.CommonResult;
import com.bone.base.core.pojo.PageResult;
import com.bone.base.core.util.servlet.ServletUtils;
import com.bone.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.bone.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.bone.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.bone.infra.service.codegen.CodegenService;
import com.bone.infra.service.codegen.CodegenServiceImpl;
import com.bone.infra.service.codegen.DDDCodegenServiceImpl;
...
public class CodegenController {
    ...
    @Resource(type= DDDCodegenServiceImpl.class)
    private CodegenService codegenService;

    //@Resource(type= DDDCodegenServiceImpl.class)
    //private CodegenService dddCodegenServiceImpl;
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "name", value = "表名，模糊匹配", example = "bone", dataTypeClass = String.class),
    ...
    @ApiImplicitParam(name = "tableId", value = "表编号", required = true, example = "1024", dataTypeClass = Long.class)
    @PreAuthorize("@ss.hasPermission('infra:codegen:download')")
    public void downloadCodegenDDD(@RequestParam("tableIds")  List<Long> tableIds,
    ...
    HttpServletResponse response) throws IOException {
        ...
        // 生成代码
        Map<String, String> codes = codegenService.generationCodes(basePackage,module,tableIds);
        // 构建 zip 包
        String[] paths = codes.keySet().toArray(new String[0]);
        ByteArrayInputStream[] ins = codes.values().stream().map(IoUtil::toUtf8Stream).toArray(ByteArrayInputStream[]::new);
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        ...
        String file="codegen-"+module+".zip";
        // 输出
        ServletUtils.writeAttachment(response, file, outputStream.toByteArray());
    }
