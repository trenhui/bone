...
import com.bone.infra.enums.logger.ApiErrorLogProcessStatusEnum;
import com.bone.infra.dal.mysql.logger.ApiErrorLogMapper;
...
import static com.bone.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.bone.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("bone-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("bone-test");
