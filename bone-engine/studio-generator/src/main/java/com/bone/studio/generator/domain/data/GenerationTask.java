...
public class GenerationTask extends AggregateRoot<Long> {
    ...
    public static GenerationTask create(Long id, Long tenantId, String taskId, String projectName, 
                                      String basePackage, String moduleName, Long dataSourceId, 
                                      List<String> tableNames, List<Long> templateIds, String genConfig) {
