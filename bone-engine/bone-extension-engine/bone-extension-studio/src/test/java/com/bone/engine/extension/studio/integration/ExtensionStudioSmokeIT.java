  ...
  void overviewAndPointsList() {
    ...
    ResponseEntity<Map<String, Object>> overview =
        restTemplate.exchange(
            base + "/overview", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
    ...
    ResponseEntity<Map<String, Object>> points =
        restTemplate.exchange(
            base + "/points", HttpMethod.GET, null, new ParameterizedTypeReference<>() {});
