...
import com.bone.engine.extension.studio.application.service.common.ResourceUtils;
...
public class ClassScanner {
     ...
     * @return 成功处理的类数量
     */
    public static int scanAndProcessClasses(List<String> basePackages, Predicate<Class<?>> classFilter, Consumer<Class<?>> classProcessor) {
    ...
    public static <A extends java.lang.annotation.Annotation> int scanAndProcessAnnotatedClasses(
        ...
        return scanAndProcessClasses(basePackages, 
