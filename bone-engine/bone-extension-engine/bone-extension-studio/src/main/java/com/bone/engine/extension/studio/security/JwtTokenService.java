...
public class JwtTokenService {
    ...
    public Optional<JwtPrincipal> parse(String rawToken) {
        try {
            ...
            return Optional.of(new JwtPrincipal(userId, username, tenantId, parseScopes(payload.get("scopes"), payload.get("scope"))));
    ...
    private static List<String> parseScopes(Object scopesClaim, Object scopeClaim) {
        ...
        if (scopes.isEmpty() && scopeClaim instanceof String scopeString && StringUtils.hasText(scopeString)) {
