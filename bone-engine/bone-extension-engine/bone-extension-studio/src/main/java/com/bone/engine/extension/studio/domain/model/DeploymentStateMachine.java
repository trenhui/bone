...
public final class DeploymentStateMachine {
    ...
    private static final Map<DeploymentStatus, List<DeploymentStatus>> TRANSITIONS = buildTransitions();
    ...
    private static Map<DeploymentStatus, List<DeploymentStatus>> buildTransitions() {
        ...
        m.put(DeploymentStatus.UPLOADED, List.of(DeploymentStatus.VALIDATED, DeploymentStatus.REJECTED));
