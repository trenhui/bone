...
public class MedicalClaimException extends BusinessException {
     ...
     * @return 医疗理赔异常实例
     */
    public static MedicalClaimException insufficientMaterials(String claimId, String missingMaterials) {
        return new MedicalClaimException("INSUFFICIENT_MATERIALS", 
                "理赔材料不足: " + missingMaterials, claimId);
    }
    ...
    public static MedicalClaimException reviewRejected(String claimId, String reason) {
        return new MedicalClaimException("REVIEW_REJECTED", 
                "理赔审核拒绝: " + reason, claimId);
    }
}