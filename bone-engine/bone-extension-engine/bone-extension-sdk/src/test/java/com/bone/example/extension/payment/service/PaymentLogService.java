...
public interface PaymentLogService {
   ...
   * 记录支付结果日志
   *
   * <p>记录完整的支付结果信息，包括交易ID、金额、状态等关键信息
   *
   ...
   * @param errorCode 错误码
   */
  void logPaymentException(
      String transactionId, String orderId, String errorMessage, String errorCode);

  /**
   * 记录支付请求日志
   *
   * <p>记录支付请求的详细信息，用于请求追踪和问题排查
   *
   * @param orderId 订单ID
   * @param userId 用户ID
   * @param amount 支付金额
  ...
  void logPaymentRequest(
      String orderId, String userId, String amount, String paymentMethod, long requestTime);
}
