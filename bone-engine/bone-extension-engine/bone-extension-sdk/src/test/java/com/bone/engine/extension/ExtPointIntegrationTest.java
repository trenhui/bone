...
public class ExtPointIntegrationTest {
    ...
    void setUp() {
        ...
        ExtensionConfigProperties configProperties = new ExtensionConfigProperties();
        DefaultExtPointRouter router = new DefaultExtPointRouter(repository, configProperties);
