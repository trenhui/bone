 ...
 * 医疗保险理赔服务企业级完整测试套件
 *
 * <p>对MedicalClaimService的核心功能进行全面测试，确保服务能够正确处理各种理赔场景。
 */
...
class MedicalClaimServiceTest {
  ...
  @Autowired private MedicalClaimService medicalClaimService;
  ...
  void shouldRejectInvalidClaimRequest() {
    // 准备无效的测试数据 - 缺少必要字段
    MedicalClaimRequest invalidRequest =
        MedicalClaimRequest.builder()
            .claimId("INVALID-001")
            // 缺少userId和claimType
