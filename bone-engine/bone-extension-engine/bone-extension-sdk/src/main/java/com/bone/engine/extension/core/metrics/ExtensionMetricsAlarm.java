...
public class ExtensionMetricsAlarm {
    ...
    private void checkFailureRate() {
        ...
        //     triggerAlarm(ExtensionAlarmService.AlarmLevel.WARNING, "High failure rate detected", context);
        // }
     ...
     * @param context 上下文信息
     */
    private void triggerAlarm(ExtensionAlarmService.AlarmLevel level, String message, Map<String, Object> context) {
        // 检查告警冷却时间
    ...
    public void recordFailure() {
        ...
        if (count >= FAILURE_COUNT_THRESHOLD) {
            ...
            triggerAlarm(ExtensionAlarmService.AlarmLevel.WARNING, "Consecutive failures detected", context);
