 ...
 *
 * <p>指标名：{@code extension_invoke_total}、{@code extension_invoke_duration_seconds}、
 * {@code extension_router_no_match_total}、{@code extension_bulkhead_rejected_total}。
 */
@Slf4j
