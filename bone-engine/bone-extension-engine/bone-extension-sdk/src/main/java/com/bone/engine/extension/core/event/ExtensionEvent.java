 ...
 *
 * <p>支持观察者模式，允许系统各组件监听和响应扩展点相关事件，实现松耦合的架构设计 事件包含扩展点执行上下文、执行状态、时间戳等关键信息
 *
 * @author renhui.trh
 * @since 1.0.0
 */
public class ExtensionEvent<T> extends ApplicationEvent {
    ...
    private void validate() {
      ...
      if ((eventType == EventType.BEFORE_INVOKE
        ...
        throw new IllegalArgumentException(
            "Extension point name cannot be null for invocation events");
      }
    }
  }
  ...
  public boolean isRegistrationEvent() {
    return eventType == EventType.BEFORE_REGISTER || eventType == EventType.AFTER_REGISTER;
  }
  ...
  public boolean isCacheEvent() {
    return eventType == EventType.CACHE_HIT || eventType == EventType.CACHE_MISS;
  }
