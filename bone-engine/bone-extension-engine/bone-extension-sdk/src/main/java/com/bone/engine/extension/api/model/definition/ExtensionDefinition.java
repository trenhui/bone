...
public class ExtensionDefinition implements Serializable, Comparable<ExtensionDefinition> {
  ...
  /** 重要：兼容 DefaultExtensionPointRouter 的四级路由逻辑 返回所有有效维度（标准维度 + 自定义维度），保证精确/模糊匹配能命中 */
  ...
  public boolean isValid() {
    return StringUtils.hasText(code) && StringUtils.hasText(extensionPoint) && instance != null;
  }
  ...
  public static class Builder {
    ...
    public Builder implementationClass(String implementationClass) {
      def.implementationClass = implementationClass;
      return this;
    }
    ...
    public Builder bizCode(String bizCode) {
      def.setBizCode(bizCode);
      return this;
    }

    public Builder useCase(String useCase) {
      def.setUseCase(useCase);
      return this;
    }
    ...
    public Builder userGroup(String userGroup) {
      def.setUserGroup(userGroup);
      return this;
    }

    public Builder dimension(String key, String value) {
      def.setDimensionRule(key, value);
      return this;
    }

    public Builder dimensions(Map<String, String> dims) {
      def.setDimensionRules(dims);
      return this;
    }
    ...
    public Builder priority(int priority) {
      def.priority = Math.max(1, priority);
      return this;
    }
