 ...
 * 扩展点文档注解
 *
 * <p>为扩展点接口提供结构化文档信息，支持API文档自动生成。 该注解仅在编译期生效，不会增加运行时内存开销。
 *
 * @since 1.0.0
...
public @interface ExtensionPointDoc {
  ...
  /** 扩展点业务名称（中文） 用于在文档和管理界面中标识 */
  String name() default "";

  /** 扩展点所属业务领域 例如：order, payment, inventory, member, messaging 用于组织和分类扩展点 */
  String domain() default "";

  /** 扩展点功能分类 例如：create, query, update, delete, calculate, validate, process 用于进一步细分扩展点功能 */
