...
public interface ExtensionRepository {
     ...
     */
    @Nullable
    ExtensionDefinition registerExtension(@NonNull String extensionPoint, @NonNull ExtensionDefinition extension);
     ...
     */
    @Nullable
    ExtensionDefinition unregisterExtension(@NonNull String extensionPoint, @NonNull String extensionCode);

    // ==================== 核心查询方法 ====================

    /**
     * [高频-路由器使用] 获取启用的扩展实现列表
     * 注意：这个方法会被频繁调用，实现应该进行性能优化（缓存等）
     */
    @NonNull
     ...
     */
    @NonNull
    Optional<ExtensionDefinition> getExtensionByCode(@NonNull String extensionPoint, @NonNull String extensionCode);
     ...
     * @return 成功注册的数量
     */
    int batchRegisterExtensions(@NonNull Map<String, Collection<ExtensionDefinition>> extensionsByPoint);
    ...
    class ExtensionRepositoryStats {
        ...
        public ExtensionRepositoryStats(String repositoryName, int totalExtensionPoints,
        ...
        public int getTotalExtensionPoints() { return totalExtensionPoints; }
        ...
        public String toString() {
            return String.format(
                    ...
                    repositoryName, totalExtensionPoints, totalExtensions, enabledExtensions,
                    getEnabledRate() * 100, getAverageExtensionsPerPoint());
        }
    }
}