...
public class ExtensionSandbox {
    ...
    private static class SandboxPolicy extends Policy {
        ...
        public PermissionCollection getPermissions(ProtectionDomain domain) {
            // 获取原始权限
            PermissionCollection permissions = originalPolicy != null ? 
                    originalPolicy.getPermissions(domain) : super.getPermissions(domain);
        ...
        public boolean implies(ProtectionDomain domain, Permission permission) {
            ...
            return originalPolicy != null ? 
                    originalPolicy.implies(domain, permission) : super.implies(domain, permission);
        }
    }
