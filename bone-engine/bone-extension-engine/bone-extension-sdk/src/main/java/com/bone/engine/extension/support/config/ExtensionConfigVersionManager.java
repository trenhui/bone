...
public class ExtensionConfigVersionManager {
   ...
   * @return 版本号
   */
  public int recordConfigChange(
      String configKey, String oldValue, String newValue, String operator) {
    List<ConfigVersion> versions =
        versionHistory.computeIfAbsent(configKey, k -> new ArrayList<>());
    ...
    log.info(
        "Config change recorded: key={}, version={}, operator={}", configKey, version, operator);
    return version;
  }
