...
public class NacosExtensionRepository implements ExtensionRepository {
  ...
  private final Executor executor =
      Executors.newSingleThreadExecutor(r -> new Thread(r, "nacos-extension-repo-refresher"));
  ...
  private void loadFromNacos() {
    try {
      ...
      if (content != null && !content.trim().isEmpty()) {
        Map<String, Map<String, ExtensionDefinition>> data =
            objectMapper.readValue(
                content, new TypeReference<Map<String, Map<String, ExtensionDefinition>>>() {});
        storage.clear();
        storage.putAll(data);
          ...
          new Listener() {
            ...
            public void receiveConfigInfo(String configInfo) {
              try {
                ...
                Map<String, Map<String, ExtensionDefinition>> newData =
                    objectMapper.readValue(
                        configInfo,
                ...
                log.info(
                    "Nacos extension repo refreshed, {} extension points loaded", storage.size());
              } catch (Exception e) {
  ...
  public ExtensionDefinition registerExtension(
    ...
    Map<String, ExtensionDefinition> pointExtensions =
        storage.computeIfAbsent(extensionPoint, k -> new ConcurrentHashMap<>());
