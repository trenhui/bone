...
@ConditionalOnProperty(
    prefix = "bone.extension",
    name = "enabled",
    havingValue = "true",
    matchIfMissing = true)
@Slf4j
@Import({
  ExtensionAsyncConfig.class,
  ExtensionExecutorConfiguration.class,
  ExtensionSecurityConfiguration.class,
  ExtensionScaffoldConfiguration.class
})
public class ExtensionAutoConfiguration implements ImportAware {
  ...
  public ExtensionEventPublisher extensionEventPublisher(
      ...
      @Qualifier(ExtensionAsyncConfig.EXTENSION_EVENT_EXECUTOR_BEAN_NAME)
  ...
  public ExtensionRepository extensionRepository(ExtensionRepositoryFactory factory) {
    try {
      ...
      if (repoClass != null) {
        log.info(
            "Using custom ExtensionRepository from @EnableExtensionPoints: {}",
            repoClass.getName());
  ...
  @Bean
  @ConditionalOnMissingBean
  public ExtensionMetricsCollector extensionMetricsCollector(
  ...
  public ExtensionMetricsBridge extensionMetricsBridge(
      org.springframework.beans.factory.ObjectProvider<ExtensionMetricsCollector>
          metricsCollector) {
  ...
  @Bean
  @ConditionalOnMissingBean
  public ExtensionMetricsAlarm extensionMetricsAlarm(
