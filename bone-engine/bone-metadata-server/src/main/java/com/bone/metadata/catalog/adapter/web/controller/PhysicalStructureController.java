...
import com.bone.metadata.catalog.application.command.handler.ReconcilePhysicalStructureHandler;
...
public class PhysicalStructureController {
  ...
  private final ReconcilePhysicalStructureHandler reconcilePhysicalStructureHandler;
  ...
  public ApiResponse<PhysicalStructurePlan> dropColumn(
    ...
    return ApiResponse.success(
        reconcilePhysicalStructureHandler.dropColumn(entityId, req.fieldCode()));
  }
  ...
  public ApiResponse<PhysicalStructurePlan> dropDrifted(@PathVariable Long entityId) {
    return ApiResponse.success(reconcilePhysicalStructureHandler.dropDriftedColumns(entityId));
  }
