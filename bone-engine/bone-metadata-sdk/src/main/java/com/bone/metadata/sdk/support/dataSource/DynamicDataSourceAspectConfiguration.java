...
/** 动态数据源切面配置类 配置AOP切面，拦截@DataSourceSwitch注解的方法调用 */
@Configuration(proxyBeanMethods = false)
public class DynamicDataSourceAspectConfiguration {

  private static final Logger log =
      LoggerFactory.getLogger(DynamicDataSourceAspectConfiguration.class);

  /** 默认的切点表达式，拦截所有带有@DataSourceSwitch注解的方法和类 */
  private static final String DEFAULT_POINTCUT_EXPRESSION =
      "@annotation(com.bone.metadata.sdk.support.dataSource.DataSourceSwitch) || @within(com.bone.metadata.sdk.support.dataSource.DataSourceSwitch)";
