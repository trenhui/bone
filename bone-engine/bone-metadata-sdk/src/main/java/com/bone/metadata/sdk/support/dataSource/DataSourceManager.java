 ...
 * retrieval, switching, and health checking. It provides a unified abstraction for multi-data
 * source management with thread-safe operations.
 */
public interface DataSourceManager {
  ...
  /**
   * Executes an action with a specific data source and returns the result. This method ensures that
   * the data source is properly switched back to the original one after execution, even if an
   * exception occurs.
   *
  ...
  /**
   * Sets the strict mode flag. When enabled, operations will throw exceptions for invalid states
