...
public final class ExceptionUtils {
     ...
     * @return 查询构建异常
     */
    public static QueryBuildException createQueryBuildException(String message, Class<?> entityType, String phase) {
     ...
     * @return 查询执行异常
     */
    public static QueryExecutionException createQueryExecutionException(String message, String sql, Throwable cause) {
