...
public class MetadataSdkContext {
  ...
  public MetadataSdkContext(MetadataSdkProperties props, DataSourceProperties dsProps) {
  ...
  private static void check() {
    if (INSTANCE == null) {
      throw new IllegalStateException("MetadataSdkContext 尚未初始化，请检查 Spring 配置");
    }
  }
