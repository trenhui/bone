...
public class ExceptionHandler {
  ...
  public SDKException handleException(Throwable e) {
    ...
    if (e instanceof IllegalArgumentException) {
      ...
      enhancedException =
          new SqlInjectionRiskException("Security violation detected", e).setRiskLevel("HIGH");
    } else if (e instanceof ClassCastException) {
      enhancedException =
          new SDKException("CLASS_CAST_ERROR", "Type conversion failed: " + e.getMessage(), e);
      ...
      enhancedException =
          new SDKException(
              "UNEXPECTED_ERROR", e.getMessage() != null ? e.getMessage() : "Unknown error", e);
    }
   ...
   * @return 查询构建异常
   */
  public QueryBuildException createQueryBuildException(
   ...
   * @return 查询执行异常
   */
  public QueryExecutionException createQueryExecutionException(
