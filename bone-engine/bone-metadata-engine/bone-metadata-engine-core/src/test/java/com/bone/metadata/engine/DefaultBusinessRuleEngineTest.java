...
/** DefaultBusinessRuleEngine的单元测试类 遵循JUnit 5和Mockito最佳实践 */
class DefaultBusinessRuleEngineTest {

  @Mock private BusinessRuleRegistry businessRuleRegistry;

  @Mock private ExpressionEngine expressionEngine;

  @InjectMocks private DefaultBusinessRuleEngine ruleEngine;
