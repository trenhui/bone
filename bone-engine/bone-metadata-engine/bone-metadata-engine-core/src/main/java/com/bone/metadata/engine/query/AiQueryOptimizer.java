...
/** AI增强的智能查询优化器 集成先进的AI技术和查询优化策略，提供智能查询重写、索引优化、性能分析等功能 */
@Slf4j
@Component
public class AiQueryOptimizer {

  @Autowired private QueryPerformanceMonitor queryMonitor;

  @Autowired private UserContext userContext;

  // 缓存优化模式和结果
  private final Map<String, String> optimizationCache =
  ...
  /**
   * 智能优化SmartQL查询 综合应用多种AI优化策略，包括查询重写、索引优化、JOIN优化、谓词下推等
   *
  ...
  public String optimizeQuery(
    ...
    //     logger.debug("实体 {} 的AI查询优化未启用", entityMetadata.getEntityName());
    //     return smartql;
    // }
  ...
  /** AI驱动的查询重写 分析查询模式，应用基于历史性能数据的优化策略 */
  private String rewriteQueryWithAi(
      String smartql,
      EntityMetadata entityMetadata,
      Map<String, Object> parameters,
      String userId) {
