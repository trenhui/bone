...
public class StrategyValidationExecutor {
  ...
  // 默认验证策略执行顺序
  private static final List<String> DEFAULT_STRATEGY_ORDER =
      Arrays.asList(
  ...
  @Autowired
  public StrategyValidationExecutor(
      ValidationStrategyFactory strategyFactory, Executor taskExecutor) {
  ...
  public void executeStrategies(
      ...
      boolean failFast) {
    log.debug("开始执行验证策略，实体类型: {}, 快速失败模式: {}", entityMetadata.getApiName(), failFast);
   ...
   */
  public CompletableFuture<ValidationResult> executeStrategiesAsync(
      EntityMetadata entityMetadata, Map<String, Object> entityData, boolean failFast) {
   ...
   */
  public CompletableFuture<List<ValidationResult>> executeBatchStrategiesAsync(
      EntityMetadata entityMetadata, List<Map<String, Object>> entityDataList, boolean failFast) {
   ...
   */
  public void executeStrategiesInOrder(
      EntityMetadata entityMetadata,
      Map<String, Object> entityData,
      ValidationResult result,
