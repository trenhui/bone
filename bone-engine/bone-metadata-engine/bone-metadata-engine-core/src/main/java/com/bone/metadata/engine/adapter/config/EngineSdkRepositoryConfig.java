package com.bone.metadata.engine.adapter.config;
 ...
 *
 * <p>注：本配置类由 {@code bone-metadata-engine-core} 的 {@code @ComponentScan} 自动扫描， 实际数据源由宿主（{@code
 * bone-metadata-server}，模式 B）提供。引擎作为库本身不含数据源。
 */
@Configuration
