...
public class ValidationStrategyFactory {
  ...
  private void registerDefaultStrategies(
      RelationshipValidationStrategy.EntityMetadataProvider metadataProvider) {
    // 注册必填字段验证策略
  ...
  private void discoverStrategies() {
    try {
      ServiceLoader<ValidationStrategy> serviceLoader =
          ServiceLoader.load(ValidationStrategy.class);
