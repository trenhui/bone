...
public class FieldMetadata {
  ...
  /** 获取权限元数据（兼容方法） */
  public com.bone.metadata.engine.domain.metadata.FieldLevelSecurityMetadata
      getPermissionMetadata() {
    // 返回FieldLevelSecurityMetadata实例
    com.bone.metadata.engine.domain.metadata.FieldLevelSecurityMetadata metadata =
        new com.bone.metadata.engine.domain.metadata.FieldLevelSecurityMetadata();
    return metadata;
  }
