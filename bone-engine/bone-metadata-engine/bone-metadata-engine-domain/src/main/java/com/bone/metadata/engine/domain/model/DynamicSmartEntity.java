...
/** 动态智能实体类 用于在运行时动态表示实体实例，支持灵活的数据访问和操作 */
@Getter
@Setter
public class DynamicSmartEntity extends SmartBaseEntity implements Serializable {
  ...
  public void startTrackingChanges() {
    ...
    try {
      ...
      if (super.hasField("createdDate"))
        originalValues.put("createdDate", super.getField("createdDate"));
      if (super.hasField("createdBy")) originalValues.put("createdBy", super.getField("createdBy"));
      if (super.hasField("lastModifiedDate"))
        originalValues.put("lastModifiedDate", super.getField("lastModifiedDate"));
      if (super.hasField("lastModifiedBy"))
        originalValues.put("lastModifiedBy", super.getField("lastModifiedBy"));
    } catch (Exception ignored) {
      // 忽略不存在的字段异常
    }
  ...
  public Map<String, Object> getAllFields() {
    ...
    try {
      ...
      if (super.hasField("createdDate"))
        allFields.put("createdDate", super.getField("createdDate"));
      if (super.hasField("createdBy")) allFields.put("createdBy", super.getField("createdBy"));
      if (super.hasField("lastModifiedDate"))
        allFields.put("lastModifiedDate", super.getField("lastModifiedDate"));
      if (super.hasField("lastModifiedBy"))
        allFields.put("lastModifiedBy", super.getField("lastModifiedBy"));
      if (super.hasField("systemModstamp"))
        allFields.put("systemModstamp", super.getField("systemModstamp"));
