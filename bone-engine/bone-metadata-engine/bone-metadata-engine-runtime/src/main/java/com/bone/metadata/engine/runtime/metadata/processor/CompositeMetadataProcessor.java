package com.bone.metadata.engine.runtime.metadata.processor;
...
import com.bone.metadata.engine.runtime.metadata.MetadataChangeEvent;
import java.util.*;
...
public class CompositeMetadataProcessor implements MetadataProcessor {
  ...
  private final List<com.bone.metadata.engine.runtime.MetadataEngine.MetadataChangeListener>
  ...
  private void publishMetadataChangeEvent(
    ...
    for (com.bone.metadata.engine.runtime.MetadataEngine.MetadataChangeListener listener :
  ...
  public void registerMetadataChangeListener(
      com.bone.metadata.engine.runtime.MetadataEngine.MetadataChangeListener listener) {
