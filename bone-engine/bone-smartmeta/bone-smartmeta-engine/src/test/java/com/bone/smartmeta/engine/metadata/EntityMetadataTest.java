...
class EntityMetadataTest {
    ...
    @ParameterizedTest
    @CsvSource({
        "Customer, customer, 客户实体",
        "Product, product, 产品实体",
        "Order, order, 订单实体"
    })
    void testEntityMetadataWithDifferentValues(String entityName, String apiName, String description) {
        // 参数化测试，覆盖多种输入场景
