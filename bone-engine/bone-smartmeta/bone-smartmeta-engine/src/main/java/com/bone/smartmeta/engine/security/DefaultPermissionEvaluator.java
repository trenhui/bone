...
public class DefaultPermissionEvaluator implements PermissionEvaluator {
    ...
    public boolean hasOperationPermission(CustomAuthentication authentication, String operation) {
        ...
        if (operation.endsWith("Create") || operation.endsWith("Update") || operation.endsWith("Delete")) {
    ...
    @Override
    public boolean hasPermission(CustomAuthentication authentication, String entityName, String operation) {
        // 管理员拥有所有权限
        if (hasRole(authentication, "ADMIN")) {
            return true;
        }
    ...
    @Override
    public boolean hasRecordAccessPermission(CustomAuthentication authentication, String entityName, Object recordId) {
        // 管理员可以访问所有记录
        if (hasRole(authentication, "ADMIN")) {
            return true;
        }
    ...
    @Override
    public List<String> getAccessibleFields(CustomAuthentication authentication, String entityName, String operation) {
    ...
    @Override
    public boolean hasFieldPermission(CustomAuthentication authentication, String entityName, String fieldName, String operation) {
        EntityMetadata metadata = getEntityMetadata(entityName);
        if (metadata == null) {
            return false;
        }
    ...
    @Override
    public List<Object> validateBatchOperation(CustomAuthentication authentication, String entityName, List<Object> recordIds, String operation) {
        // 验证用户是否有操作权限
