...
public class RuleEngineAutoConfiguration {
    ...
    /**
     * 创建规则引擎Bean
     * 使用@Primary确保这是首选的RuleEngine实现
     */
    @Bean
    @Primary
    @ConditionalOnMissingBean
    public RuleEngine ruleEngine(ExpressionEngine expressionEngine,
                               MetadataEngine metadataEngine,
                               ExpressionCache expressionCache,
                               EvaluationContextFactory evaluationContextFactory,
                               CustomFunctionRegistry customFunctionRegistry) {
        return new RuleEngine(expressionEngine, 
                            metadataEngine, 
                            expressionCache, 
