...
public class RuleEngineConfig {
     ...
     */
    @Bean
    public BusinessRuleEngine businessRuleEngine(BusinessRuleRegistry businessRuleRegistry, ExpressionEngine expressionEngine) {
        return new DefaultBusinessRuleEngine(businessRuleRegistry, expressionEngine);
    }
    
    /**
     * 统一规则引擎适配器
     * 将BusinessRuleEngine适配为UnifiedRuleEngine接口
     */
    @Bean
    ...
    private static class UnifiedRuleEngineAdapter implements UnifiedRuleEngine<Object> {
        ...
        @Override
        public com.bone.smartmeta.engine.validation.ValidationResult validate(Object entity, RuleContext context) {
            // 适配器实现，将Object转换为DynamicSmartEntity
            if (entity instanceof com.bone.smartmeta.engine.model.DynamicSmartEntity) {
                com.bone.smartmeta.engine.validation.ValidationResult result = 
                    com.bone.smartmeta.engine.validation.ValidationResult.success();
                delegate.executeValidationRules((com.bone.smartmeta.engine.model.DynamicSmartEntity) entity, result);
                return result;
            }
            return com.bone.smartmeta.engine.validation.ValidationResult.failure("不支持的实体类型");
        }
        
        @Override
        public com.bone.smartmeta.engine.validation.ValidationResult executeRules(Object entity, String ruleType, RuleContext context) {
            // 根据规则类型执行相应的规则
            ...
            return com.bone.smartmeta.engine.validation.ValidationResult.failure("不支持的规则类型: " + ruleType);
        }
        
        @Override
        public java.util.List<com.bone.smartmeta.engine.model.BusinessRuleMetadata> getApplicableRules(Object entity, String eventType) {
            if (entity instanceof com.bone.smartmeta.engine.model.DynamicSmartEntity) {
                return delegate.getRulesForEvent(
                    ((com.bone.smartmeta.engine.model.DynamicSmartEntity) entity).getEntityApiName(), 
                    eventType
                );
            }
        ...
        @Override
        public boolean validateRule(com.bone.smartmeta.engine.model.BusinessRuleMetadata rule) {
            return delegate.validateRule(rule);
        }
        
        @Override
        public java.util.List<String> getRuleDependencies(com.bone.smartmeta.engine.model.BusinessRuleMetadata rule) {
            return delegate.getRuleDependencies(rule);
        }
        
        @Override
        public void executeValidationRules(com.bone.smartmeta.engine.model.DynamicSmartEntity entity, 
                                         com.bone.smartmeta.engine.validation.ValidationResult result) {
            delegate.executeValidationRules(entity, result);
        }
        
        @Override
        public void executeActionRules(com.bone.smartmeta.engine.model.DynamicSmartEntity entity, String eventType) {
            delegate.executeActionRules(entity, eventType);
        }
        
        @Override
        public Object executeRule(com.bone.smartmeta.engine.model.DynamicSmartEntity entity, 
                                com.bone.smartmeta.engine.model.BusinessRuleMetadata rule, 
