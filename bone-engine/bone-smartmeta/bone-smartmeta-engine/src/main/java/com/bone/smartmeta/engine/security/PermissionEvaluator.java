...
public interface PermissionEvaluator {
     ...
     * @return 是否有权限
     */
    boolean hasRecordAccessPermission(CustomAuthentication authentication, String entityName, Object recordId);
     ...
     * @return 有权访问的字段列表
     */
    List<String> getAccessibleFields(CustomAuthentication authentication, String entityName, String operation);
     ...
     * @return 是否有权限
     */
    boolean hasFieldPermission(CustomAuthentication authentication, String entityName, String fieldName, String operation);
     ...
     * @return 没有权限的记录ID列表
     */
    List<Object> validateBatchOperation(CustomAuthentication authentication, String entityName, List<Object> recordIds, String operation);
}