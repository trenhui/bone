...
public class SecurityDemoApplication {
     ...
     * 演示认证功能
     */
    private static void demoAuthentication(PermissionEvaluator permissionEvaluator, 
    ...
    private static void demoDataProcessing(FieldLevelSecurityManager securityManager) {
        ...
        System.out.println("\nVIEWER用户读取数据（可能会脱敏）:");
        try {
            Map<String, Object> processedData = securityManager.processDataAccess(
                    viewerAuth, "user", testData, "READ");
