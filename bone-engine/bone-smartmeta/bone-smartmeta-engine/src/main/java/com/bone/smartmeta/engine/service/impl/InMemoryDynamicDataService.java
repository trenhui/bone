...
public class InMemoryDynamicDataService implements DynamicDataService {
    ...
    @Override
    public Map<String, Object> queryPage(String entityName, Map<String, Object> queryParams,
                                        int page, int size) {
        ...
        List<Map<String, Object>> pageResults = fromIndex < toIndex ?
            allResults.subList(fromIndex, toIndex) : Collections.emptyList();
    ...
    @Override
    public List<Map<String, Object>> batchCreate(String entityName, List<Map<String, Object>> dataList) {
        List<Map<String, Object>> results = new ArrayList<>();
    ...
    @Override
    public List<Map<String, Object>> batchUpdate(String entityName, List<Map<String, Object>> dataList) {
        List<Map<String, Object>> results = new ArrayList<>();
        for (Map<String, Object> data : dataList) {
            String id = (String) data.get("id");
            if (id != null) {
    ...
    @Override
    public Object executeOperation(String entityName, String operationName, Map<String, Object> params) {
        // 简化实现
        Map<String, Object> result = new HashMap<>();
