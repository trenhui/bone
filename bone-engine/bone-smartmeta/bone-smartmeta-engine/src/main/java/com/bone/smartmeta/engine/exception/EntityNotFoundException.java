...
public class EntityNotFoundException extends BaseBusinessException {
     ...
     * @param cause 根异常
     */
    public EntityNotFoundException(String message, String errorCode, ExceptionLevel level, Throwable cause) {
     ...
     * @param context 上下文信息
     */
    public EntityNotFoundException(String message, String errorCode, ExceptionLevel level, Throwable cause, Map<String, Object> context) {
