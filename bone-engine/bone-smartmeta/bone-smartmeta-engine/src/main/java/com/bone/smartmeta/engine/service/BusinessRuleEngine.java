 ...
 * 统一业务规则引擎接口
 * 提供基于元数据的业务规则管理和执行功能
 * 替代硬编码的业务规则验证逻辑（如validateOrderItems方法）
 */
public interface BusinessRuleEngine {
     ...
     * @return 规则执行结果
     */
    RuleResult executeRules(String entityName, Map<String, Object> entityData, List<String> ruleNames);
     ...
     * @return 评估结果
     */
    boolean evaluateCondition(String entityName, Map<String, Object> entityData, String conditionExpression);
}