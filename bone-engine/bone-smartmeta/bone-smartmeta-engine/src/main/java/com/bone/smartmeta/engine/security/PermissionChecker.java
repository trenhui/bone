...
public class PermissionChecker {
     ...
     */
    public boolean hasEntityAccessPermission(String entityName, String userId, String permissionType) {
        ...
        // 例如：return permissionService.hasPermission(userId, entityName, permissionType);
