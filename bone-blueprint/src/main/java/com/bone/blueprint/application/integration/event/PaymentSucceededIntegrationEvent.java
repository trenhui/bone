 ...
 *
 * <p><b>为何在 application 包</b>：见 {@link OrderPaidIntegrationEvent} 类注释——集成事件是 application
 * 层出站端口的契约载荷。
 */
public record PaymentSucceededIntegrationEvent(
  ...
  public static PaymentSucceededIntegrationEvent fromDomain(
    ...
    return new PaymentSucceededIntegrationEvent(
        paymentId, tenantId, orderId, amount, channelTradeNo, occurredAt, CURRENT_SCHEMA_VERSION);
  }
}
