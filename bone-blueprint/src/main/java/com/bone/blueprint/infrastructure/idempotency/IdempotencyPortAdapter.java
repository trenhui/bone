 ...
 *
 * <p>幂等能力已上收 framework：编排在 {@code com.bone.core.idempotency.IdempotencyService}，本模块只提供存储实现。 原先本地声明的
 * {@code IdempotencyPort} 端口已随之删除（不要为本类再补一个本地端口接口）。
 *
...
@ConditionalOnProperty(
    ...
    havingValue = "true",
    matchIfMissing = true)
public class IdempotencyPortAdapter implements IdempotencyStore {
