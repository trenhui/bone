...
@Component
@ConditionalOnProperty(name = "bone.blueprint.outbox.mq-enabled", havingValue = "false", matchIfMissing = true)
@Slf4j
public class LoggingOrderMessageSender implements OrderMessageSender {
    ...
    public void send(String topic, String partitionKey, String envelopeJson) {
        log.info("blueprint-outbox-relay topic={} partitionKey={} envelope={}", topic, partitionKey, envelopeJson);
    }
}
