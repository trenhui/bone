...
public class HandlerRegistry {
    ...
    public static class CapabilityMetadata {
        ...
        public CapabilityMetadata(String name, String description, String inputSchema, String outputSchema, boolean idempotent, int cost, boolean retryable, int timeout) {
            this.name = name;
