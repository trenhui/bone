 ...
 *
 * <p>按 E-3 R1 依赖向内原则，adapter 层直接依赖 domain 端口（{@link OrderOutboxRelayPort}），不经过 application 层中转。
 * v4.8 复核修正：删除原 {@code OrderOutboxRelayOrchestrator} 中转层（纯技术转发，无业务编排，违反 E-5.3 「Orchestrator
 * 禁承载纯技术轮询/中继」），Job 直注端口。
 */
@Slf4j
@Component
