package com.bone.base.tracer.config;

import com.bone.base.core.enums.WebFilterOrderEnum;
import com.bone.base.tracer.core.aop.BizTraceAspect;
import com.bone.base.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "bone.tracer", value = "enable", matchIfMissing = true)
public class BoneTracerAutoConfiguration {
