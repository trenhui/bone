 ...
 * 租户拦截器
 * <p>
 * 从请求头提取租户信息，并设置到租户上下文中
 * 支持扩展点机制，如果存在BizContext类，会同步设置到业务上下文
 * </p>
 */
@Slf4j
@Component
public class TenantInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        try {
            ...
            log.debug("租户上下文已设置: tenantId={}, bizCode={}, uri={}", 
                    tenantId, bizCode, request.getRequestURI());
    ...
    private void setBizContext(Long tenantId, String bizCode) {
        try {
            Class<?> bizContextClass = Class.forName("com.bone.engine.extension.support.context.BizContext");
