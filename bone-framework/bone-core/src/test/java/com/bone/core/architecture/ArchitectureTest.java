package com.bone.core.architecture;
...
/** bone-core 架构守护。framework 库，DDD 分层规则无匹配类时统一空过。 */
@AnalyzeClasses(packages = "com.bone.core", importOptions = ImportOption.DoNotIncludeTests.class)
