...
/**
 * 多租户聚合根：{@link AggregateRoot} + {@code tenantId}。不继承 {@link com.bone.core.tenant.TenantAbstractEntity}，避免与域内
 * {@link java.time.LocalDateTime} 审计字段冲突；审计由子类自行声明（见 bone-iam {@code Account}）。
 */
@Getter
