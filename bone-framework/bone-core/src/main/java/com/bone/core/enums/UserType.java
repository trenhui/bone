...
public enum UserType {
    //================ 系统核心角色 ================
    ROOT_ADMIN("根管理员", RoleDomain.SYSTEM, PermissionLevel.ALL,
            "系统最高权限管理员", true, true, true),
    SYSTEM_ADMIN("系统管理员", RoleDomain.SYSTEM, PermissionLevel.ADMIN,
            "负责系统全局配置", true, true, true),
    AUDITOR("审计员", RoleDomain.SYSTEM, PermissionLevel.READ_ONLY,
            "系统操作审计监督", true, false, true),
    SYSTEM_BOT("系统机器人", RoleDomain.SYSTEM, PermissionLevel.SERVICE,
            "自动执行系统任务", false, false, false),

    //================ 组织管理角色 ================
    ORG_OWNER("组织所有者", RoleDomain.ORGANIZATION, PermissionLevel.ADMIN,
            "组织最高管理者", true, true, true),
    ORG_ADMIN("组织管理员", RoleDomain.ORGANIZATION, PermissionLevel.ADMIN,
            "管理组织资源", true, true, true),
    ORG_MANAGER("部门经理", RoleDomain.ORGANIZATION, PermissionLevel.STANDARD,
            "部门级管理权限", false, true, false),
    ORG_MEMBER("组织成员", RoleDomain.ORGANIZATION, PermissionLevel.STANDARD,
            "普通成员权限", false, false, false),
    ORG_VIP("高级成员", RoleDomain.ORGANIZATION, PermissionLevel.PREMIUM,
            "付费高级功能权限", false, false, false),
    ORG_GUEST("访客成员", RoleDomain.ORGANIZATION, PermissionLevel.LIMITED,
            "受限访问权限", false, false, false),

    //================ 外部协作角色 ================
    PARTNER_ADMIN("合作伙伴管理员", RoleDomain.EXTERNAL, PermissionLevel.LIMITED,
            "第三方协作管理", true, true, true),
    EXTERNAL_USER("外部用户", RoleDomain.EXTERNAL, PermissionLevel.LIMITED,
            "外部协作人员", false, false, false),
    API_CLIENT("API客户端", RoleDomain.EXTERNAL, PermissionLevel.SERVICE,
            "系统集成账户", false, false, false),

    //================ 特殊场景角色 ================
    GUEST("访客", RoleDomain.PUBLIC, PermissionLevel.READ_ONLY,
            "未认证临时用户", false, false, false),
    ANONYMOUS("匿名用户", RoleDomain.PUBLIC, PermissionLevel.NONE,
            "完全匿名访问", false, false, false);
    ...
    //================ 构造函数 ================
    UserType(String displayName, RoleDomain domain, PermissionLevel basePermission,
             String description, boolean allowMFA, boolean allowOverride, boolean requireAudit) {
    ...
    public Set<String> getEffectivePermissions() {
        return Collections.unmodifiableSet(
                PERMISSION_MAP.getOrDefault(this, Collections.emptySet())
        );
    }
...
class PermissionExtension {
    ...
    public static void registerDynamicPermissions() {
        ...
        dynamicPermissions.forEach((type, perms) ->
                perms.forEach(perm -> UserType.PERMISSION_MAP
