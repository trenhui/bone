...
/**
 * 聚合根基类（领域事件）。审计字段见 {@link com.bone.core.domain.entity.AbstractEntity} / {@link
 * com.bone.core.tenant.TenantAbstractEntity}；需审计的聚合可继承 {@link AuditableAggregateRoot}（ADR-0011 阶段
 * 2）。
 */
@Getter
