...
public final class ReflectionUtil {
    ...
    // 基本类型装箱兼容性映射（预计算提升性能）
    private static final Map<Class<?>, Class<?>> BOXING_COMPATIBILITY_MAP = createBoxingCompatibilityMap();
     ...
     */
    @Nullable
    public static <A extends Annotation> Class<A> getInterfaceByAnnotation(@Nullable Class<?> targetClass,
                                                                           @Nullable Class<A> annotationClass) {
        // 检查目标类是否为空
     ...
     */
    @NonNull
    public static Object newInstance(@NonNull Class<?> clazz, @Nullable Class<?>[] parameterTypes,
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    public static <T> T invokeMethod(@NonNull Object target, @NonNull String methodName,
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    public static <T> T invokeStaticMethod(@NonNull Class<?> clazz, @NonNull String methodName,
                                           @Nullable Object... arguments) {
        Assert.notNull(clazz, "Class cannot be null");
        Assert.hasText(methodName, "Method name cannot be blank");
        ...
        try {
            ...
            throw new ReflectionException("Static method execution failed: " + methodName, e.getTargetException());
        }
    }
     ...
     * 设置字段值
     */
    public static void setFieldValue(@NonNull Object target, @NonNull String fieldName,
     ...
     * 设置静态字段值
     */
    public static void setStaticFieldValue(@NonNull Class<?> clazz, @NonNull String fieldName,
                                           @Nullable Object value) {
        Assert.notNull(clazz, "Class cannot be null");
        Assert.hasText(fieldName, "Field name cannot be blank");
     ...
     */
    @NonNull
    private static Method findMethod(@NonNull Class<?> clazz, @NonNull String methodName,
                                     @Nullable Object[] arguments) {
        MethodSignature signature = new MethodSignature(clazz, methodName, getParameterTypes(arguments));

        return METHOD_CACHE.compute(signature, (key, existingRef) -> {
            try {
     ...
     */
    @Nullable
    private static MethodHandle findMethodHandle(@NonNull Class<?> clazz, @NonNull String methodName,
                                                 @Nullable Object[] arguments) {
        try {
            MethodSignature signature = new MethodSignature(clazz, methodName, getParameterTypes(arguments));

            SoftReference<MethodHandle> handleRef = METHOD_HANDLE_CACHE.compute(signature, (key, existingRef) -> {
                try {
                    ...
                    log.debug("Method handle creation failed for {}.{}", clazz.getSimpleName(), methodName, e);
                    return null;
                }
            });
     ...
     */
    @NonNull
    private static Method locateMethod(@NonNull Class<?> clazz, @NonNull String methodName,
                                       @Nullable Class<?>[] parameterTypes) throws NoSuchMethodException {
        try {
     ...
     */
    @NonNull
    private static Optional<Method> findCompatibleMethod(@NonNull Class<?> clazz,
        ...
        return Arrays.stream(clazz.getMethods())
                ...
                .max(Comparator.comparingInt(method ->
    ...
    private static Field findField(@NonNull Class<?> clazz, @NonNull String fieldName) {
        ...
        return FIELD_CACHE.compute(signature, (key, existingRef) -> {
            try {
     ...
     */
    @NonNull
    private static Constructor<?> findConstructor(@NonNull Class<?> clazz,
                                                  @Nullable Class<?>[] parameterTypes) {
        ConstructorSignature signature = new ConstructorSignature(clazz, parameterTypes);

        return CONSTRUCTOR_CACHE.compute(signature, (key, existingRef) -> {
            try {
     ...
     */
    @NonNull
    private static Constructor<?> locateConstructor(@NonNull Class<?> clazz,
                                                    @Nullable Class<?>[] parameterTypes)
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    private static <T> T invokeWithMethodHandle(@NonNull MethodHandle methodHandle,
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    private static <T> T invokeWithReflection(@NonNull Object target, @NonNull String methodName,
                                              @Nullable Object[] arguments) {
        try {
     ...
     */
    private static void ensureAccessible(@NonNull AccessibleObject accessible, @Nullable Object target) {
     ...
     * 缓存统计信息
     */
    public record CacheStats(int methodCacheSize, int fieldCacheSize,
                             int methodHandleCacheSize, int constructorCacheSize) {
        @Override
        public String toString() {
            return String.format("MethodCache: %d, FieldCache: %d, MethodHandleCache: %d, ConstructorCache: %d",
