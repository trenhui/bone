///*
//package com.bone.base.swagger.config;
//
//import com.bone.base.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
//
//import static com.bone.base.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
//@ConditionalOnProperty(prefix = "bone.swagger", value = "enable", matchIfMissing = true)
//@EnableConfigurationProperties(SwaggerProperties.class)
//public class BoneSwaggerAutoConfiguration {
//
//    @Bean
...
////                .apis(basePackage("com.bone.module.system")) // 可用于 swagger 无法展示时使用
