...
import com.bone.metadata.auth.application.vo.role.RoleRespVO;
...
public class RoleController {
    ...
    public Result<Long> createRole(@Valid @RequestBody RoleSaveReqVO createReqVO) {
    ...
    public Result<Boolean> updateRole(@Valid @RequestBody RoleSaveReqVO updateReqVO) {
    ...
    public Result<RoleRespVO> getRole(@RequestParam("id") Long id) {
    ...
    //@PreAuthorize("@ss.hasPermission('system:role:query')")
    public Result<PageResult<RoleRespVO>> getRolePage(RolePageReqVO pageReqVO) {
    ...
    public Result<List<RoleRespVO>> getSimpleRoleList() {
