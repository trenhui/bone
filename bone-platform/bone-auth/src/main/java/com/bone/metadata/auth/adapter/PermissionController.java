...
import com.bone.metadata.auth.application.vo.permission.PermissionAssignRoleDataScopeReqVO;
import com.bone.metadata.auth.application.vo.permission.PermissionAssignRoleMenuReqVO;
import com.bone.metadata.auth.application.vo.permission.PermissionAssignUserRoleReqVO;
...
//    @PreAuthorize("@ss.hasPermission('system:permission:assign-role-menu')")
    public Result<Set<Long>> getRoleMenuList(@RequestParam("roleId") Long roleId) {
...
//    @PreAuthorize("@ss.hasPermission('system:permission:assign-user-role')")
    public Result<Set<Long>> listAdminRoles(@RequestParam("userId") Long userId) {
