...
import com.bone.masterdata.infrastructure.config.GlobalExceptionHandler;
 ...
 *
 * <p>锁定：masterdata 的 {@link GlobalExceptionHandler} 在任何非 2xx 响应里都产出带 {@code errorCode} 的
 * ProblemDetail（masterdata 该分支不附结构化 {@code errors}，本测试仅校验 errorCode 透传）。
 */
