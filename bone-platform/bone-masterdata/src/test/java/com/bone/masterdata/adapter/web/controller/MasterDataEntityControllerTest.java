...
public class MasterDataEntityControllerTest {
  ...
  public void testCreate() {
    CreateMasterDataEntityCommand cmd =
        CreateMasterDataEntityCommand.builder()
            .name("测试实体")
            .description("测试主数据实体")
            .category("default")
            .build();
  ...
  public void testUpdate() {
    ...
    UpdateMasterDataEntityCommand cmd =
        UpdateMasterDataEntityCommand.builder()
            .id(entity.getId())
            .name("更新后的实体")
            .description("更新后的描述")
            .category("default")
  ...
  public void testDetail() {
    ...
    ApiResponse<MasterDataEntityDTO> apiResponse =
        masterDataEntityController.detail(entity.getId());
