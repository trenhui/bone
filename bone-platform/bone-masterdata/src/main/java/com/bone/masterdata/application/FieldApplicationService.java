 ...
 *
 * <p>原 {@code application/command/handler/*Field*} 与 {@code application/query/handler/*Field*}
 * 的全部用例已内联合并到本服务。 读侧领域模型经由 {@link MasterDataFieldRepository} 的 default 方法承载（ADR-0030），应用层不直接依赖持久化
 * DSL。
 */
@Service
