...
public class MasterDataEntityPageQueryHandler {
  ...
  public PageResult<MasterDataEntityDTO> handle(MasterDataEntityPageQuery qry) {
    ...
    com.bone.core.model.PageResult<MasterDataEntity> result =
        query.orderByDesc(MasterDataEntity::getCreatedAt).page(qry.getPageNum(), qry.getPageSize());

    List<MasterDataEntityDTO> dtoList =
