...
class IntegrationOutboxRelayTest {
    ...
    @Mock
    private IntegrationMessageSender messageSender;
    ...
    void relayBatch_marksRecordSentOnSuccess() {
        ...
        verify(messageSender).send(record.getTopic(), record.getPartitionKey(), record.getEnvelopeJson());
    ...
    void relayBatch_incrementsRetryOnFailure() {
        ...
        ArgumentCaptor<IntegrationOutboxRecord> captor = ArgumentCaptor.forClass(IntegrationOutboxRecord.class);
