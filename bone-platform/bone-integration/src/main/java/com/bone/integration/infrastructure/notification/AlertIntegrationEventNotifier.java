...
public class AlertIntegrationEventNotifier implements IntegrationEventNotifier {
    ...
    private void dispatch(AlertLevel level, String action, String title, String content, String businessId) {
        try {
            ...
            log.error("integration alert dispatch failed: action={}, businessId={}", action, businessId, ex);
        }
    }
}
