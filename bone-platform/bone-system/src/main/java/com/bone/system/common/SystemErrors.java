...
public final class SystemErrors {
  ...
  private static final Map<String, Integer> DEFAULT_HTTP_STATUS =
      Map.ofEntries(
          ...
          Map.entry(SystemErrorCodes.DICT_TYPE_NOT_FOUND, 404),
          Map.entry(SystemErrorCodes.DICT_TYPE_CODE_CONFLICT, 409),
          Map.entry(SystemErrorCodes.DICT_TYPE_READONLY, 403),
          Map.entry(SystemErrorCodes.DICT_TYPE_IN_USE, 409),
          Map.entry(SystemErrorCodes.DICT_ITEM_NOT_FOUND, 404),
          Map.entry(SystemErrorCodes.DICT_ITEM_CODE_CONFLICT, 409),
          Map.entry(SystemErrorCodes.DICT_ITEM_HAS_CHILDREN, 409),
          Map.entry(SystemErrorCodes.DICT_PARENT_NOT_FOUND, 400),
          Map.entry(SystemErrorCodes.DICT_PARENT_NOT_ALLOWED, 400),
          Map.entry(SystemErrorCodes.DICT_CYCLE_DETECTED, 409),
          Map.entry(SystemErrorCodes.DICT_CASCADE_DEPTH_EXCEEDED, 400),
          Map.entry(SystemErrorCodes.DICT_CODE_INVALID, 400),
          Map.entry(SystemErrorCodes.DICT_CATEGORY_INVALID, 400),
          Map.entry(SystemErrorCodes.DICT_ENUM_CLASS_INVALID, 400),
          Map.entry(SystemErrorCodes.DICT_IMPORT_TOO_LARGE, 400),
          Map.entry(SystemErrorCodes.DICT_VALUE_INVALID, 400),
          Map.entry(SystemErrorCodes.DICT_EFFECTIVE_RANGE_INVALID, 400),
          Map.entry(SystemErrorCodes.DICT_HIERARCHY_NOT_FOUND, 404),
