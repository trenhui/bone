 ...
 * <p>关键策略：
 * <ul>
 *   <li>无状态：JWT only，无 Session；</li>
 *   <li>公开：CORS preflight、Actuator、Swagger、{@code /h2-console}（dev）；</li>
 *   <li>其余端点要求认证，授权由方法级 {@code @PreAuthorize} 完成（控制台为
 *       {@code sys:console:read}）。</li>
 * </ul>
 */
@Configuration
@EnableWebSecurity
