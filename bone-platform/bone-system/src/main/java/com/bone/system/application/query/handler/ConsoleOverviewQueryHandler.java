 ...
 *
 * <p>编排三类 Gateway —— ServiceHealth / ResourceUsage / KeyMetrics，组装为单一读侧值对象。
 * Micrometer 计数器 {@code bone_console_overview_refresh_total} 与 PromQL 真源
 * {@code Bone-可观测性规范.md} §4.2.1 对齐。
 */
@Component
