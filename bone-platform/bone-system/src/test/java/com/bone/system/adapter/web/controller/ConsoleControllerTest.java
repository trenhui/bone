...
class ConsoleControllerTest {
  ...
  void overview() throws Exception {
            ...
            ConsoleOverview.builder()
                ...
                .keyMetrics(
                    KeyMetrics.builder()
                        .userCount(1)
                        .entityCount(2)
                        .integrationFlowCount(3)
                        .extensionPluginCount(4)
                        .updatedAt(Instant.now())
                        .build())
                .alerts(List.of())
                .updatedAt(Instant.now())
    ...
    mockMvc
        .perform(get("/api/v1/console/overview"))
  ...
  void services() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v1/console/services"))
        .andExpect(status().isOk())
  ...
  void resources() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v1/console/resources"))
        .andExpect(status().isOk())
  ...
  void metrics() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v1/console/metrics"))
        .andExpect(status().isOk())
  ...
  void quickActions() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v1/console/quick-actions"))
        .andExpect(status().isOk())
