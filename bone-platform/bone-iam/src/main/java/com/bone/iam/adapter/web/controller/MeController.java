 ...
 *
 * <ul>
 *   <li>{@code GET    /api/v1/iam/me}                  —— 我的资料 + scopes</li>
 *   <li>{@code PUT    /api/v1/iam/me}                  —— 更新昵称/手机/头像</li>
 *   <li>{@code POST   /api/v1/iam/me/change-password}  —— 旧密码校验后改密</li>
 * </ul>
 */
@RestController
...
public class MeController {
    ...
    public ApiResponse<MeResp> me() {
        ...
        return ApiResponse.success(accountDetailQueryHandler.handle(accountId)
                .map(account -> {
