...
public class AuthorityCacheEvictionService implements AccountAuthorityCache {
    ...
    public AuthorityCacheEvictionService(@Autowired(required = false) StringRedisTemplate redisTemplate) {
    ...
    public void evictAccountsForRole(Long roleId) {
        ...
        List<Long> accountIds = QueryBuilder.from(AccountRole.class)
