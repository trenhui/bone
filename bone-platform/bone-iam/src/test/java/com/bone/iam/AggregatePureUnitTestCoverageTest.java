 ...
 *
 * <p>存量 9 个聚合（{@code Account}/{@code AuditLog}/{@code BoneApplication}/{@code BoneModule}/{@code
 * Dept}/{@code Menu}/{@code Permission}/{@code Role}/{@code Tenant}）纯单测已补齐（2026-09-05）， 门禁由 {@code
