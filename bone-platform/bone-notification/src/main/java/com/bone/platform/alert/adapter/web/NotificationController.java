...
public class NotificationController {
  ...
  public ApiResponse<List<NotificationMessage>> list(
    ...
    return ApiResponse.success(notificationService.listByUser(userId, limit));
  }
  ...
  public ApiResponse<Map<String, Object>> summary(@RequestParam Long userId) {
    ...
    result.put("unreadCount", notificationService.unreadCount(userId));
    result.put("messages", notificationService.listByUser(userId, 10));
