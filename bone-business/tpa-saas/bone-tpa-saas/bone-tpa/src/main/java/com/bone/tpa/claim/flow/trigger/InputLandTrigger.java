...
@Service
@Slf4j
public class InputLandTrigger  extends SyncTaskTemplate {
    @Autowired
    ...
    public void syncOneData(SyncTask task) {
        ...
        inputFlowFireService.doLandEvent(claimRepository.findById(jsonObject.getLong("claimNumber")));
    }
}
