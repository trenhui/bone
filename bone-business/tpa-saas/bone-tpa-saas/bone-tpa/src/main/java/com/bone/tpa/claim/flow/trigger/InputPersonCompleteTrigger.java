...
@Service
@Slf4j
public class InputPersonCompleteTrigger extends SyncTaskTemplate {

    @Autowired
    InputStageService inputStageService;
    /**
     * 所属业务
     *
     * @return
    ...
    public void syncOneData(SyncTask task) {
        ...
        inputStageService.inputPersonComplete(claimNumber,operator,task.getCreateTime());
