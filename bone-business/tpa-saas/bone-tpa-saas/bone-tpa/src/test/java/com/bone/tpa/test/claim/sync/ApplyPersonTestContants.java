...
public class ApplyPersonTestContants {
    /**
     * 人员姓名
     * 如果传入null，则清空字段
     */
    static  public String name="李四";
    ...
    /**
     ...
     static   * 如果传入null，则清空字段
     static   */
    static  public String   birthday= "2022-01-01";
    ...
    /**
     ...
     static   * 如果传入null，则清空字段
     static   */
    static  public   String identityNo="330103198103040717";
    ...
    /**
     ...
     static   * 如果传入null，则清空字段
     static   */
    static  public String identityStart= "2022-01-02";
    ...
    /**
     ...
     static   * 如果传入null，则清空字段
     static   */
    static  public String identityEnd = "2025-11-12";
    /**
     static   * 从事职业中文，走选项集
     static   * 如果传入null，则清空字段
     static   */
