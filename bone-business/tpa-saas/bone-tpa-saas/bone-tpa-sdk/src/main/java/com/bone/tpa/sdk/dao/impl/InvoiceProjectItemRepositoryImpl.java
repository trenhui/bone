...
@Repository
public class InvoiceProjectItemRepositoryImpl extends BaseRepository<InvoiceProjectItem, Long> implements InvoiceProjectItemRepository {

    @Autowired
    public InvoiceProjectItemRepositoryImpl(SqlBuilder sqlBuilder, SqlExecutor sqlExecutor, ExtensionCoordinator extensionCoordinator) {
