...
/**
 * @describe: 推送直付身份证类型(直付通用版本)
 * @author: wangxiaokun
 * @version: 1.0
 * @date 2023/11/30 09:03
 **/

public enum ZfIdentityTypeEnum {
    ...
    private ZfIdentityTypeEnum(String key1, String key2, String value) {
        this.key1 = key1;
        this.key2 = key2;
        this.value = value;
    }
    ...
    public static String getKey2(String key1) {
        for (ZfIdentityTypeEnum b : ZfIdentityTypeEnum.values()) {
            if (b.getKey1().equals(key1)) {
                return b.getKey2();
            }
        }
        return "";
