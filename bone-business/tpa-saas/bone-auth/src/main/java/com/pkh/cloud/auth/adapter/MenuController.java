...
import com.pkh.cloud.auth.application.vo.MenuRespVO;
import com.pkh.cloud.auth.application.vo.MenuSaveVO;
import com.pkh.cloud.auth.application.vo.MenuSimpleRespVO;
...
public class MenuController {
    ...
    public Result<Long> createMenu(@Valid @RequestBody MenuSaveVO createReqVO) {
    ...
    public Result<Boolean> updateMenu(@Valid @RequestBody MenuSaveVO updateReqVO) {
    ...
    public Result<List<MenuRespVO>> getMenuList(MenuListReqVO reqVO) {
    ...
    public Result<List<MenuSimpleRespVO>> getSimpleMenuList() {
    ...
    public Result<MenuRespVO> getMenu(@RequestParam("id")Long id) {
