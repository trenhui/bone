...
import com.pkh.cloud.auth.application.convert.AuthConvert;
...
public class AuthController {
    ...
    @PostMapping("/loginTokenByRSA")
    @PermitAll
    @Operation(summary = "使用加密key登录")
    public Result<String> loginTokenByRSA(@RequestBody LoginCipherDTO dto) {
        return success(authService.loginTokenByRSA(dto));
    }
}
