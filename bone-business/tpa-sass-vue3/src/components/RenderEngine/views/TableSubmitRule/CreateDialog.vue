<script setup>
import { getTableSubmitRuleOptions } from "@/enums/rule/TableSubmitRuleMapping";
import {
  TableSubmitRuleType,
...
const handleClose = () => {
  ...
  ruleType.value = TableSubmitRuleType.IN_ROW;
...
<template>
  ...
  >
    <div class="dialog-content">
      ...
      <div
        class="my-5"
        v-for="item in getTableSubmitRuleOptions(ruleType)"
        :key="item.value"
      >
