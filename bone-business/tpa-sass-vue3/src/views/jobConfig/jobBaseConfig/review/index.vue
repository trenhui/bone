...
<template>
  <el-tabs v-model="currentTab">
    <el-tab-pane lazy label="列表页面" name="LIST_PAGE">
      ...
      <common-list-config :code="ProcessPageCodeEnum.REVIEW_LIST" />
    </el-tab-pane>
