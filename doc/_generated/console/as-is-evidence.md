...
| `cqrs-handler` | CQRS Query Handler 编排（readOnly） | java: 3 |
| `gateway-ports` | 出站端口（ServiceHealth/ResourceUsage/KeyMetrics） | java: 7 |
...
| `permission-code` | sys:console:read 权限码四处对齐 | ddl_id_18: ✓ · frontend_const: ✓ · admin_fallback: ✓ · controller_doc: 3 |
| `domain-read-vos` | 读侧值对象位于 domain.model.console（ArchUnit 友好） | java: 5 |
