...
> **生成时间**：2026-09-25T21:19:45Z（UTC）  
> **收集器**：`tools/metadata-compliance-collector/collect.py`

| ID | 能力 | 摘要 |
|----|------|------|
| `meta-ddl-five-tables` | meta_* 五表在 bone-init.sql | DDL 4/5 表 |
...
| `eav-allocate-201` | fields:allocate 返回 201（EAV 局部符合 AIP-133） | 源码 × 3 |
| `catalog-if-match-entity` | meta_entity PUT/publish If-Match + 412（AIP-154） | 源码 × 7 |
