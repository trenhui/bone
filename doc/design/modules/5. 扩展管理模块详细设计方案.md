...
收集器：`python3 tools/extension-compliance-collector/collect.py --sync-doc`（见 [tools/README](../../../tools/extension-compliance-collector/README.md)）。
...
> **生成时间**：2026-05-27T02:13:41Z UTC · 已落地项**不得**写入 backlog，见 [附录 C](#附录-c-as-is-证据ci-派生) 与 §2 符合度矩阵。
...
> **CI 派生**（2026-05-27T02:13:41Z UTC）· 完整 JSON 见 [`doc/_generated/extension/compliance.json`](../../_generated/extension/compliance.json)
...
- **CI**：`extension-studio.yml` 增加 `docs-compliance` job；`scripts/ci/collect-extension-compliance.sh`
