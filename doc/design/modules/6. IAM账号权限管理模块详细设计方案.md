...
**仓库对照（As-Is）**：`bone-platform/bone-iam` · 默认 HTTP **8081** · API 前缀以 Controller 与网关配置为准（常见 `/api/v1/iam` 或经 Shell 代理 `/api/iam`）  
...
| pwd_updated_at | DATETIME(3) | 密码最后修改时间 |
...
| `/api/iam/sso/callback` | GET | SSO回调 | 无 |
...
| `/api/iam/users/{id}` | GET | 获取用户详情 | 管理员 |
| `/api/iam/users/{id}` | PUT | 更新用户 | 管理员 |
| `/api/iam/users/{id}` | DELETE | 删除用户 | 管理员 |
| `/api/iam/users/{id}/enable` | POST | 启用用户 | 管理员 |
| `/api/iam/users/{id}/disable` | POST | 禁用用户 | 管理员 |
| `/api/iam/users/{id}/reset-password` | POST | 重置密码 | 管理员 |
| `/api/iam/users/import` | POST | 导入用户 | 管理员 |
| `/api/iam/users/export` | GET | 导出用户 | 管理员 |
...
| `/api/iam/permissions` | POST | 创建权限 | 管理员 |
| `/api/iam/permissions/{id}` | GET | 获取权限详情 | 管理员 |
| `/api/iam/permissions/{id}` | PUT | 更新权限 | 管理员 |
| `/api/iam/permissions/{id}` | DELETE | 删除权限 | 管理员 |
| `/api/iam/permissions/tree` | GET | 获取权限树 | 管理员 |
...
| `/api/iam/audit/logs/export` | GET | 导出审计日志 | 管理员 |
| `/api/iam/audit/settings` | GET | 获取审计设置 | 管理员 |
| `/api/iam/audit/settings` | PUT | 更新审计设置 | 管理员 |

### 5.6 多租户管理API

| API路径 | 方法 | 功能 | 权限 |
|---------|------|------|------|
| `/api/iam/tenants` | GET | 获取租户列表 | 系统管理员 |
| `/api/iam/tenants` | POST | 创建租户 | 系统管理员 |
| `/api/iam/tenants/{id}` | GET | 获取租户详情 | 系统管理员 |
| `/api/iam/tenants/{id}` | PUT | 更新租户 | 系统管理员 |
| `/api/iam/tenants/{id}` | DELETE | 删除租户 | 系统管理员 |
| `/api/iam/tenants/{id}/enable` | POST | 启用租户 | 系统管理员 |
| `/api/iam/tenants/{id}/disable` | POST | 禁用租户 | 系统管理员 |
| `/api/iam/tenants/{id}/quota` | PUT | 更新租户配额 | 系统管理员 |
