...
│   └── event/                    # AccountCreatedEventHandler / RoleCreatedEventHandler / AuditLogCreatedEventHandler
├── domain/
│   ├── model/
...
│   │   │               │   │       ├── CreateRoleCommandHandler.java
│   │   │               │   │       ├── CreatePermissionCommandHandler.java
│   │   │               │   │       └── AssignPermissionCommandHandler.java
│   │   │               │   ├── query/             # 查询
│   │   │               │   │   ├── qry/            # 查询对象（子包短名）
│   │   │               │   │   │   ├── UserPageQuery.java
│   │   │               │   │   │   ├── RolePageQuery.java
│   │   │               │   │   │   ├── PermissionPageQuery.java
│   │   │               │   │   │   └── AuditLogListQuery.java
│   │   │               │   │   ├── handler/        # 查询处理器
...
│   │   │               │       ├── RoleCreatedEventHandler.java
│   │   │               │       └── AuditLogCreatedEventHandler.java
│   │   │               │
│   │   │               ├── domain/                # 领域层（零依赖）
│   │   │               │   ├── model/             # 领域模型
│   │   │               │   │   ├── user/         # 用户领域
