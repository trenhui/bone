...
| max_users | INT | 最大用户数 |
| max_entities | INT | 最大实体数 |
| storage_limit | BIGINT | 存储容量限制（GB） |
| api_limit | INT | API调用限制（次/天） |
| status | VARCHAR(20) | 状态（启用、禁用） |
| create_time | DATETIME | 创建时间 |
| update_time | DATETIME | 更新时间 |
