...
### 5.1 EAV 扩展字段 API（**As-Is**）

> 与 [Bone-API-规范](../../architecture/Bone-API-规范.md) 一致，使用 **`/api/v1/metadata/**`** 前缀。下表为 **§1.1 扩展字段 EAV**（不含 §1.2 建模 catalog 与 §1.3 runtime CRUD，那两者见 §5.2）。
