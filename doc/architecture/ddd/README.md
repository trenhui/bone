...
> 主文档（完整条文）：[Bone-DDD-最终实践方案.md](../Bone-DDD-最终实践方案.md)（v4.2）  
> 本目录提供**补充示例、适应度指标**及后续可拆分的专题分册入口。

| 分册 | 内容 |
|------|------|
| [07-supplements.md](./07-supplements.md) | 代码示例、领域事件发布、架构适应度仪表盘 |
| [08-module-acl-status.md](./08-module-acl-status.md) | 各模块 ACL / ArchUnit 清零状态 |
