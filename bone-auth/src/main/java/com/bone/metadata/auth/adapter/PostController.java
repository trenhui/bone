...
import com.bone.metadata.auth.application.vo.dept.PostRespVO;
import com.bone.metadata.auth.application.vo.dept.PostSaveReqVO;
...
public class PostController {
    ...
    public Result<Long> createPost(@Valid @RequestBody PostSaveReqVO createReqVO) {
    ...
    public Result<Boolean> updatePost(@Valid @RequestBody PostSaveReqVO updateReqVO) {
    ...
    public Result<Boolean> deletePost(@RequestParam("id") Long id) {
    ...
    public Result<PostRespVO> getPost(@RequestParam("id") Long id) {
    ...
    public Result<List<PostSimpleRespVO>> getSimplePostList() {
        // 获得岗位列表，只要开启状态的
    ...
    //@PreAuthorize("@ss.hasPermission('system:post:query')")
    public Result<PageResult<PostRespVO>> getPostPage(@Validated PostPageReqVO pageReqVO) {
...
//        List<PostDO> list = postService.getPostPage(reqVO).getData();
//        // 输出
