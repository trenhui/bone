package com.bone.metadata.auth.infrastructure.util;

import cn.dev33.satoken.stp.StpUtil;
import com.bone.metadata.auth.infrastructure.config.RsaProperties;
...
//    }
    ...
    public static String decryptByPrivateKey(String privateKeyText, String text) {
        try {
            ...
            log.info("密码解密失败, 密码密文为 --> {}", text);
            throw new BizException(500, "操作失败:密码解密失败");
        }
    }
...
//        System.out.println(rsaKeyPair.getPrivateKey());
        ...
        String encryptPassword = encryptByPublicKey(RsaProperties.publicKey,"123456");
        System.out.println(encryptPassword);
        String password = decryptByPrivateKey(RsaProperties.privateKey, "CFiYTutOlbyBzsXOPJ8WxqrszLOS6H8lTYtjOm5gUMnI9iu2HUjG9r56svslO40fRBKGO8rVMQxVpyR/GfceJdHxpYnZaXxt+Ln5jgFlGzLhtBVqrsELy4APbz88Y+xQ2WL1g75mnPZrVAoHq95o03Y8KfU3GhilqShI/sTiwk8=");
